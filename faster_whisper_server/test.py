...
Determine if the following is an instruction...
"""
...
@pytest.fixture()
def query() -> str:
    return "Tell me about the weather in New York."
...
def test_speech(query) -> None:
    openai_api = OpenAI(  api_key=os.getenv("OPENAI_API_KEY"), base_url="https://api.mbodi.ai/v1")
